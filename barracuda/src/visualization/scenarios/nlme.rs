...
fn build_nca_node(scenario: &mut HealthScenario) {
    ...
    scenario.ecosystem.primals.push(node(
        ...
        vec![
            ...
            gauge("nca_cmax", "Cmax", nca.cmax, 0.0, 5.0, "mg/L", [0.5, 2.0], [2.0, 4.0]),
            gauge("nca_tmax", "Tmax", nca.tmax, 0.0, 10.0, "hr", [0.0, 2.0], [2.0, 5.0]),
            gauge("nca_auc_inf", "AUC(0-inf)", nca.auc_inf, 0.0, 2000.0, "mg·hr/L", [100.0, 1500.0], [1500.0, 1900.0]),
            gauge("nca_lambda_z", "Lambda-z", nca.lambda_z, 0.0, 0.01, "1/hr", [0.0005, 0.005], [0.005, 0.009]),
            gauge("nca_half_life", "Half-Life", nca.half_life, 0.0, 1000.0, "hr", [100.0, 700.0], [700.0, 900.0]),
            gauge("nca_cl", "Clearance", nca.cl_obs, 0.0, 0.2, "L/hr", [0.01, 0.1], [0.1, 0.18]),
            gauge("nca_vss", "Vss", nca.vss_obs, 0.0, 100.0, "L", [10.0, 80.0], [80.0, 95.0]),
        ],
        vec![ClinicalRange {
...
fn build_vpc_node(
    ...
    scenario.ecosystem.primals.push(node(
        ...
        &["science.pkpd.nlme_diagnostics"],
        vec![
            timeseries("vpc_obs_p5", "Observed 5th Percentile", "Time (hr)", "C (mg/L)", "mg/L", vpc.time_bins.clone(), vpc.obs_p5),
            timeseries("vpc_obs_p50", "Observed Median", "Time (hr)", "C (mg/L)", "mg/L", vpc.time_bins.clone(), vpc.obs_p50),
            timeseries("vpc_obs_p95", "Observed 95th Percentile", "Time (hr)", "C (mg/L)", "mg/L", vpc.time_bins.clone(), vpc.obs_p95),
            timeseries("vpc_sim_p5", "Simulated 5th Percentile", "Time (hr)", "C (mg/L)", "mg/L", vpc.time_bins.clone(), vpc.sim_p5),
            timeseries("vpc_sim_p50", "Simulated Median", "Time (hr)", "C (mg/L)", "mg/L", vpc.time_bins.clone(), vpc.sim_p50),
            timeseries("vpc_sim_p95", "Simulated 95th Percentile", "Time (hr)", "C (mg/L)", "mg/L", vpc.time_bins, vpc.sim_p95),
        ],
        vec![],
    ));
}
