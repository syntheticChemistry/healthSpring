...
**Date:** May 30, 2026 (V65b)
**License:** scyBorg (AGPL-3.0-or-later code + ORC mechanics + CC-BY-SA 4.0 creative content)
**MSRV:** 1.87
**Status:** V65b — **Wave 63 Temporal Sync**. ironGate eukaryotic (13/13 NUCLEUS, Forgejo sync live, temporal sync operational, cascade-pull 22-repo profile). Post-primordial clean. BTSP `btsp.capabilities` probe pattern implemented. `domain_profile.toml` authored for pseudoSpore emission. **59 validation scenarios** covering 58 experiment IDs. All clippy pedantic+nursery zero. All 7 deep debt categories zero. **1,056 tests** pass, 0 clippy warnings. guideStone **Level 5**. 470+-method registry. ecoBin 0.9.0. barraCuda v0.4.0. primalSpring **v0.9.27**. Zero clippy, zero unsafe, zero TODO.
...
| Metric | Value |
|--------|-------|
| Version | **V65b** (Wave 63 Temporal Sync: BTSP probe pattern, domain_profile.toml, temporal sync operational, 1,056 tests) |
