...
///
/// Volumes, blood flows, and partition coefficients from physiological references.
/// References: Brown et al. 1997, Toxicol Ind Health (doi:10.1177/074823379701300401);
