...
**Status**: V64 — UniBin + certification organelle + LTEE B5 Tier 1 + `s_toxicology` scenario + Foundation T3+T8 active; primalSpring **v0.9.25**. 95 experiments, **999 tests**, 54 Python baselines + 53 notebooks. barraCuda v0.3.13. ecoBin 0.9.0.
