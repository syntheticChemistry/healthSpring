...
**Status**: V64 — UniBin + LTEE B5 Tier 1 + Foundation T3+T8 active + `s_toxicology` scenario; guideStone Level 5. **1,011 tests**, 95 experiments, 87 capabilities. primalSpring **v0.9.25**. ecoBin 0.9.0. barraCuda v0.3.13. Onboarding document for researchers whose work we have ingested and evolved —
