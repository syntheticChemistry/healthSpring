...
**Status**: V65a — Wave 60 Eukaryotic Gate. 57 validation scenarios, all four math methods IPC-validated. barraCuda v0.4.0. All six GPU ops LIVE. ecoBin 0.9.0. primalSpring v0.9.27. CG-3 (`submit_and_map`) tracked upstream.
