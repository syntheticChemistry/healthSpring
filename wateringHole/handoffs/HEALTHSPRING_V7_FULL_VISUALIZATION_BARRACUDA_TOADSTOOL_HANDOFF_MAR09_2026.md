...
1. [ ] Wire per-track scenario loading from file or pipe
2. [ ] Add clinical range threshold rendering (green/yellow/red zones)
3. [ ] Support the `full_study()` combined view with cross-track edge routing
