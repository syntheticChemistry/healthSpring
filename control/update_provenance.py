...
FILES = [
    ...
    ("control/biosignal/exp023_baseline.json", "python3 control/biosignal/exp023_biosignal_fusion.py"),
    ("control/validation/exp040_baseline.json", "python3 control/validation/exp040_barracuda_cpu_parity.py"),
